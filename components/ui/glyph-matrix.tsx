...
export function GlyphMatrix({
    ...
    useEffect(() => {
        ...
        const imgData = probeCtx.getImageData(0, 0, 1, 1).data
    ...
    useEffect(() => {
        ...
        const draw = () => {
            ...
            ctx.font = `600 ${cellSize - 1}px ui-monospace, SFMono-Regular, Menlo, monospace`
            ...
            for (let y = 0; y < rows; y++) {
                ...
                for (let x = 0; x < cols; x++) {
                    const i = y * cols + x
                    ctx.globalAlpha = alphas[i] * fade * colorAlpha
